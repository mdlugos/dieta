...
#command @ <row>, <col> SAY <xpr> [PICTURE <pic>] [COLOR <color>] => SetPos( <row>, <col> ) ; DispOut(TRAN(<xpr>, <pic>) [, <color>] )
#command @ <row>, <col> SAY <xpr> [COLOR <color>] => SetPos( <row>, <col> ) ; DispOut( <xpr> [, <color>] )
